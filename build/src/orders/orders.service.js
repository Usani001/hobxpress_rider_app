...
var OrdersService = /** @class */ (function () {
    function OrdersService(orderConnection, authService) {
        this.orderConnection = orderConnection;
        this.authService = authService;
    }
    OrdersService.prototype.create = function (body, req) {
        return __awaiter(this, void 0, void 0, function () {
            var tokUser, saveOrder, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.orderConnection.save(body)];
                    case 2:
                        saveOrder = _a.sent();
                        return [2 /*return*/, {
                                status: true,
    ...
    OrdersService.prototype.findOrder = function (body, req) {
        return __awaiter(this, void 0, void 0, function () {
            var tokUser, getOrder_1, getOrder, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        tokUser = _a.sent();
                        return [4 /*yield*/, this.orderConnection.find({
                    ...
                    case 3: return [4 /*yield*/, this.orderConnection.findOne({
                            where: { id: body.id },
                        })];
                    case 4:
                        getOrder = _a.sent();
